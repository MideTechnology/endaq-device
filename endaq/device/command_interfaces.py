...
class CommandInterface:
    ...
    def __init__(self,
        ...
        self.hostId: Optional[bytes] = None
...
class SerialCommandInterface(CommandInterface):
            ...
            try:
                while True:
                    if 'EBMLCommand' in cmd:
                        ...
                        # FUTURE: when the firmware enforces LockIDs, include
                        #   LockID in all commands (if set).

                        # if self.hostId:
                        #     cmd['EBMLCommand']['LockID'] = self.hostId
    ...
    def setLockID(self,
        ...
        """ Set a unique 'lock' ID on the device, requesting exclusive use of
            ...
            :returns: The new lock ID.
        """
        lockId = new or self.hostId or uuid4().bytes
        with self.device._busy:
            cmd = {'EBMLCommand':
                       {'SetLockID':
