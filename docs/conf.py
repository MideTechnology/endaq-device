...
release = get_version(os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'endaq', 'device', '__init__.py')))
...
html_theme_options = {
    "logo_link": "index",
    "github_url": "https://github.com/MideTechnology/endaq-device",
...
latex_documents = [
    (master_doc, 'enDAQ.tex', u'enDAQ Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'endaq', u'enDAQ Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'enDAQ', u'enDAQ Documentation',
     author, 'enDAQ', 'One line description of project.',
     'Miscellaneous'),
]
